...
<head>
    <meta charset="UTF-8">
    <title><?php echo esc_html( sprintf( __( 'Ticket #%s Created', 'arkidevs-support' ), $ticket->ticket_number ) ); ?></title>
</head>
<body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2><?php echo esc_html( sprintf( __( 'Ticket #%s Created', 'arkidevs-support' ), $ticket->ticket_number ) ); ?></h2>
        
        <p><?php esc_html_e( 'Hello,', 'arkidevs-support' ); ?></p>
        
        <p><?php esc_html_e( 'Your support ticket has been created successfully. We will review it and get back to you soon.', 'arkidevs-support' ); ?></p>
        ...
        <div style="background: #f5f5f5; padding: 15px; margin: 20px 0;">
            ...
            <p><strong><?php esc_html_e( 'Priority:', 'arkidevs-support' ); ?></strong> <?php echo esc_html( Arkidevs_Support_Priority::get_priority_label( $ticket->priority ) ); ?></p>
        </div>
