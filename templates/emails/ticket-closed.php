...
<head>
    <meta charset="UTF-8">
    <title><?php echo esc_html( sprintf( __( 'Ticket #%s Closed', 'arkidevs-support' ), $ticket->ticket_number ) ); ?></title>
</head>
<body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2><?php echo esc_html( sprintf( __( 'Ticket #%s Closed', 'arkidevs-support' ), $ticket->ticket_number ) ); ?></h2>
        
        <p><?php esc_html_e( 'Hello,', 'arkidevs-support' ); ?></p>
        
        <p><?php esc_html_e( 'Your support ticket has been closed.', 'arkidevs-support' ); ?></p>
        ...
        <p style="color: #666; font-size: 12px; margin-top: 30px;">
            <?php esc_html_e( 'If you have any further questions, please create a new ticket.', 'arkidevs-support' ); ?>
        </p>
    </div>
</body>
</html>
