...
<head>
    <meta charset="UTF-8">
    <title><?php echo esc_html( sprintf( __( 'Ticket #%s Updated', 'arkidevs-support' ), $ticket->ticket_number ) ); ?></title>
</head>
<body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2><?php echo esc_html( sprintf( __( 'Ticket #%s Updated', 'arkidevs-support' ), $ticket->ticket_number ) ); ?></h2>
        
        <p><?php esc_html_e( 'Hello,', 'arkidevs-support' ); ?></p>
        
        <p><?php esc_html_e( 'Your support ticket has been updated.', 'arkidevs-support' ); ?></p>
